...
SMPL_MODEL_DIR = str(REPO_ROOT / "deps/smpl_models")
GMM_MODEL_DIR = str(REPO_ROOT / "deps/smpl_models")
SMPL_MEAN_FILE = str(REPO_ROOT / "deps/smpl_models/neutral_smpl_mean_params.h5")
# for collsion 
Part_Seg_DIR = str(REPO_ROOT / "deps/smpl_models/smplx_parts_segm.pkl")
